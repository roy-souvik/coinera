...
function showLogin(){
  ...
  <table width="45%" border="0" align="center" cellpadding="5" cellspacing="0" class="ThinTable">
	...
	<tr>
		<td colspan="2">&nbsp;</td>
		<td><a href="../index.php" target="_blank">View Site</a></td>
	</tr>
...
function login(){
	$login_sql="select * from admin_master where BINARY admin_userid='".$_POST[admin_userid]."' and BINARY admin_password='".$_POST[admin_password]."'";
	//echo "L: " . $login_sql; 
	...
	if($login_row=mysql_fetch_array($login_rs)){
		...
		$_SESSION['admin_userid']=$login_row['admin_id']; 
		header('location: admin_main.php');
	}
	else{
