...
<!-- ---------------------------------------------------------- --> 
<!--<div style="margin-left:32px;margin-top:10px;padding:5px;background-color:rgba(255, 255, 228, 0.3);" class="fb-like" data-href="http://arhamcreation.in/coinera/" data-send="false" data-width="70" data-show-faces="true"></div>
--><!-- ---------------------------------------------------------- -->
        </div>
        <div id="menu-bar">
        <ul id="navigation">
