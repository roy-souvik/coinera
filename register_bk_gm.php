...
function isNumberKey(evt)
 ...
 <?php 
	if($GLOBALS['msg']!='' || $GLOBALS['msg_user']!='' || $GLOBALS['user_status_msg']!=''){
 ?>
 <center>
	<div class="validation_message">
		<?php echo $GLOBALS['msg']."<br/>".$GLOBALS['msg_user']."<br/>".$GLOBALS['user_status_msg']; ?>
	</div>
 </center>
 <?php } ?>
  <form id="register_form" name="register" method="post" action="" enctype="multipart/form-data" onSubmit="return formValidate(this,'0');">
    <table class="register_table" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>Last Name</td><td>:</td><td><input type="text" id="last_name" name="last_name" />
      ...
      <tr>
        <td>User Name</td><td>:</td><td><input type="text" id="user_name" name="user_name" autocomplete="off"/>
        ...
        <td>Password</td><td>:</td><td><input type="password" title="Minimum Six Characters" id="password" class="password" name="password" autocomplete="off"/>
      ...
      <tr>
        <td>Confirm Password</td><td>:</td><td>
      ...
      <tr class="register_col"><td colspan="3"><div id="confirm_password_required" class="js_alert"></div></td><td colspan="3"></td></tr>
      ...
      <tr>
        <td>Address</td><td>:</td><td><textarea name="address" id="address" ></textarea>
		<!--<div id="address_required" class="js_alert"></div>--></td>

        <td>City</td><td>:</td><td><input type="text" id="city" name="city" />
      ...
      <tr>
        <td>State</td><td>:</td><td><input type="text" id="state" name="state" />
	  ...
	  <tr>
        <td>Zip Code</td><td>:</td><td><input type="text" id="zip_code" name="zip_code" onkeypress="return isNumberKey(event)" />
	...
	<!--	</td> -->
      ...
      <tr>
        <td>Phone</td><td>:</td><td><input type="text" id="phone" name="phone" onkeypress="return isNumberKey(event)" />
